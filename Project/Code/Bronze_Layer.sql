...
CREATE OR REPLACE STORAGE INTEGRATION RETAIL_S3_INT
  ...
  STORAGE_PROVIDER = 'S3'
  ENABLED = TRUE
  STORAGE_AWS_ROLE_ARN = 'arn:aws:iam::059771369153:role/project_retail'
  STORAGE_ALLOWED_LOCATIONS = 's3://project-bkt62/';
...
select system$pipe_status('pipe_supplier_raw');

desc pipe pipe_nation_raw;
desc pipe pipe_lineitem_raw;
